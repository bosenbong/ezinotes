...
export default function App() {
  ...
  const fmtNote = (rawText) => {
    ...
    // Format as detailed NDIS note
    return `Date: ${date}

SERVICE TYPE: Support Work

SESSION SUMMARY:
${cleaned}

SUPPORT PROVIDED:
- Support delivered as per participant plan
- Assistance provided with identified daily living activities

PARTICIPANT RESPONSE:
- Participant engaged positively with support
- Participant appeared receptive to assistance provided

OUTCOME:
- Session completed successfully
- Support goals addressed

NOTES / FOLLOW-UP:
- Continue with current support plan
- Review progress at next session

---
Generated by EziNotes - Review before submitting`
