...
export default function App() {
  ...
  const fmtNote = (rawText, useAbbr = true) => {
    if (!rawText) return ''
    ...
    const abbr = useAbbr ? {
      'Social & Domestic Support': 'S&D',
      'Transport': 'Transport',
      'Activities Undertaken': 'Activities',
      'Wellbeing/Outcome': 'W&B',
      'Departure': 'Departure'
    } : {}
    
    const serviceType = useAbbr ? 'S&D / Transport' : 'Social & Domestic Support / Transport'
    const activitiesHeader = useAbbr ? 'ACTIVITIES:' : 'ACTIVITIES UNDERTAKEN:'
    const wellbeingHeader = useAbbr ? 'WELLBEING:' : 'WELLBEING/OUTCOME:'
...
Generated by EziNotes - Review and edit before submitting`
  ...
  const copy = () => {
    navigator.clipboard.writeText(fmtNote(transcript, useAbbreviations))
    show('Copied!')
  }

  const save = () => {
    const blob = new Blob([fmtNote(transcript, useAbbreviations)], { type: 'text/plain' })
        ...
        <div style={{ padding: '24px' }}>
          ...
          <div style={{ 
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '14px',
                border: 'none',
                background: useAbbreviations ? '#10b981' : '#d1d5db',
                cursor: 'pointer',
                position: 'relative',
            ...
            >
              <div style={{
                ...
                position: 'absolute',
                top: '3px',
                left: useAbbreviations ? '25px' : '3px',
          ...
          <div>
            ...
            <div style={{
              ...
              {transcript ? fmtNote(transcript, useAbbreviations) : 'Your note will appear here...'}
            </div>
